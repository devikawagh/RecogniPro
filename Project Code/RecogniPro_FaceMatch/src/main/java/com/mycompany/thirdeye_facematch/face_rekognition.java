...
public class face_rekognition extends javax.swing.JFrame {
    ...
    private void open_sketchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_open_sketchActionPerformed
        JFileChooser fileChooser = new JFileChooser("C:\\Users\\iamsa\\Downloads\\Project-Code-(forensic-face-sketch)\\Project-Code-(forensic-face-sketch)\\ThirdEye_FaceMatch\\src\\main\\java\\com\\mycompany\\thirdeye_facematch\\sketches"); 
...
//                https://facesketch1.s3.ap-south-1.amazonaws.com/f-011-01.jpg
                String path = "https://facesketch1.s3.ap-south-1.amazonaws.com/"+face.getFace().getExternalImageId()+".jpg";
